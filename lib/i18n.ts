...
const dict = {
  en: {
    ...
    gallery: "Gallery",
    pendingAgency: "Your agency is waiting for TTN approval. You need 20 real client reviews and original trip photos.",
    english: "EN",
    urdu: "اردو",
  },
  ur: {
    ...
    postTrip: "سفر لگائیں",
    gallery: "گیلری",
    pendingAgency: "آپ کی ایجنسی منظوری کی منتظر ہے۔ بیس اصلی کلائنٹ ریویوز اور اصلی تصاویر درکار ہیں۔",
    english: "EN",
    urdu: "اردو",
  },
} as const;
